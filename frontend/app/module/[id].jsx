...
export default function ModuleDetail() {
  ...
  }, [id, bounceAnim, fadeAnim, fetchModuleDetails, scaleAnim]);
  ...
  const fetchModuleDetails = useCallback(async () => {
    try {
      ...
      const quizzesRes = await fetch(`${API_URL}/modules/${id}/quizzes`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const userProgress = {
    ...
    percentage:
      quizzes.length > 0
        ? Math.floor(((Math.random() * quizzes.length) / quizzes.length) * 100)
        : 0,
  };
          ...
          <View style={styles.questTitleContainer}>
            ...
            <View style={styles.questProgressContainer}>
              <Text style={styles.questProgressText}>
                {userProgress.percentage}% Complete
              </Text>
          ...
          {quizzes.length === 0 ? (
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptyStateText}>
                No challenges available on this quest yet!
              </Text>
            </View>
          ) : (
              ...
              <TouchableOpacity
                ...
                style={[
                  ...
                  !quiz.isUnlocked &&
                    ...
                    styles.lockedChallenge,
                ]}
                onPress={() =>
                  quiz.isUnlocked || user?.privilege === "admin"
                    ? navigateToQuiz(quiz._id)
                    : null
                }
              ...
              >
                ...
                <LinearGradient
                  colors={[
                    ...
                    getDifficultyColor(quiz.difficulty) + "60",
                  ]}
                  start={{ x: 0, y: 0 }}
                  end={{ x: 1, y: 0 }}
                  style={[
                    ...
                    quiz.image
                      ? styles.challengeBadgeWithImageRight
                      : styles.challengeBadgeNoImageRight,
                  ]}
                >
                ...
                <View style={styles.challengeMeta}>
                  ...
                  <View
                    style={[
                      ...
                      {
                        backgroundColor:
                          getDifficultyColor(quiz.difficulty) + "30",
                      },
                    ]}
                  >
                    <MaterialCommunityIcons
