...
export default function InstructorDashboard() {
  ...
  const normalizedRequestedOpen =
      typeof requestedOpen === "string" ? requestedOpen.toLowerCase() : null;
  const [activeTab, setActiveTab] = useState(
      normalizedRequestedOpen === "analytics" || normalizedRequestedTab === "analytics"
          ? "analytics"
  ...
  useEffect(() => {
    if (normalizedRequestedOpen === "analytics") {
  ...
  }, [normalizedRequestedOpen, normalizedRequestedTab]);
