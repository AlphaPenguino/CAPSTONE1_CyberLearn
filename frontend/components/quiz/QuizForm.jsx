      ...
      if (Platform.OS === "web") {
        ...
        input.onchange = async (e) => {
          ...
          if (file.size > 5000000) {
            // 5MB
            alert(
              "Image too large. Please select a smaller image or compress it first."
            );
            return;
          }

          // Compress image using canvas before converting to base64
          const img = Platform.OS === "web" ? new window.Image() : null;
          img.onload = () => {
            ...
            console.log(
              "Web quiz image compressed and converted, length:",
              base64data.length
            );
          };
        ...
        if (!result.canceled) {
          ...
          try {
            ...
            console.log(
              "Quiz image compressed and converted to base64, length:",
              base64.length
            );
    ...
    try {
      ...
      if (quizImageBase64) {
        ...
        const imageDataUrl = quizImageBase64.startsWith("data:image")
          ? quizImageBase64
          : `data:${imageType};base64,${quizImageBase64}`;
  ...
  const DropdownSelector = ({
    ...
    return (
      ...
      >
        ...
        >
          <View style={styles.modalOverlay} onKeyDown={handleKeyDown}>
            <View
          ...
          return (
            <View>
              <Text style={styles.helperText}>
                Use ____ (4 underscores) in your question text to indicate blank
                spaces
              </Text>
          ...
          <View key={index} style={styles.questionItem}>
            <View style={styles.questionHeader}>
              <Text style={styles.questionType}>
                {questionTypes.find((t) => t.value === question.questionType)
