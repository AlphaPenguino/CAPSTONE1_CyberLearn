...
export default function ClassForm() {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      {/* Tab bar is not in the provided code, so I'll assume it's a parent component. */}
        ...
        <View style={styles.leftColumn}>
          ...
          >
            <View style={styles.formGroup}>
              ...
              <TextInput
                style={[styles.input, classNameError && styles.inputError]}
      ...
      {/* Modals are unchanged, keeping them for completeness */}
      {/* ... (Modal components for class creation, deletion, and viewing students) ... */}
...
const styles = StyleSheet.create({
  ...
  userCard: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between', // Aligns items to both ends
    padding: 12,
    borderRadius: 8,
    marginVertical: 4,
  ...
  avatar: {
    ...
    height: 40,
    borderRadius: 20,
    marginRight: 12, // Added spacing between avatar and text
  },
  avatarFallback: {
    width: 40,
    height: 40,
  ...
  // New button style for "Create Class"
  createClassButton: {
    marginTop: 24,
  ...
  sectionName: {
    ...
    fontSize: 18,
    fontWeight: 'bold',
    maxWidth: '80%', // Prevents text from pushing stats too far
  },
  sectionStats: {
    color: '#aaaaaa',
    fontSize: 14,
