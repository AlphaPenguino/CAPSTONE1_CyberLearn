...
class RainOfWordsApiService {
  constructor() {
    this.baseUrl = `${API_URL}/rain-of-words`;
  }
  ...
  async trackGameCompletion(gameData) {
    try {
      ...
      console.error("Error tracking Rain of Words game completion:", error);
...
export default new RainOfWordsApiService();
